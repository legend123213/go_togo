...
import (
	...
	"github.com/legend123213/go_togo/Task08/task-manager/Delivery/controllers"
	...
	usecases "github.com/legend123213/go_togo/Task08/task-manager/UseCases"
...
func Api(dbmongo *mongo.Database) *gin.Engine{
	server:=gin.New()
	tr := repositories.NewTaskService(dbmongo.Collection("Tasks"))
	ur:= repositories.NewUserService(dbmongo.Collection("Users"))
